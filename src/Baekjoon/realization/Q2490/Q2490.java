	...
	private void init(){
		...
		try {
			for(int i=0; i<3; i++){
				...
				switch(result[i]){
					case 0:
						System.out.println("E");	// �� - �� 4    1 1 1 1  D
						break;
					case 1:
						System.out.println("A");	// �� - �� 1 �� 3 0 1 1 1  A
						break;
					case 2:
						System.out.println("B");	// �� - �� 2 �� 2 0 0 1 1  B
						break;
					case 3:
						System.out.println("C");	// �� - �� 3 �� 1 0 0 0 1  C
						break;
					case 4:
						System.out.println("D");	// �� - �� 4    0 0 0 0  E
						break;
					default:
						break;
				}
